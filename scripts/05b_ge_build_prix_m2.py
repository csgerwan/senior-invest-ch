...
Entrée : data/raw/homegate_ge_raw.json (annonces GE à l'achat)
Traitements :
...
Sortie : data/processed/prix_m2_immo_ge.csv
...
RAW = Path("data/raw/homegate_ge_raw.json")
GEO = Path("data/processed/communes_vd.geojson")
OUT = Path("data/processed/prix_m2_immo_ge.csv")

PRIX_M2_MIN, PRIX_M2_MAX = 4000, 45000  # fourchette plausible CHF/m² (GE, plus cher)
